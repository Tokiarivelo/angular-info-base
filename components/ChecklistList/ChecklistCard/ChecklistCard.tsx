...
import { ChecklistCardProps } from '../ChecklistList.types';
import { useChecklistProgress } from '../ChecklistList.hooks';
...
export default function ChecklistCard({
  ...
  const { completedCount, totalCount, percentage } =
    useChecklistProgress(checklist);

  return (
    <div className="group relative bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
